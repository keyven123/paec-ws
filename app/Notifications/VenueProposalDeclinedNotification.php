...
class VenueProposalDeclinedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $payload = [
            'email_page_title' => 'Proposal Declined',
            'email_headline' => 'A customer declined your proposal',
            'email_intro' => 'The customer has declined the proposal you sent. Open the inquiry chat to send a revised proposal or continue the discussion.',
        ...
        return (new MailMessage())
            ->view('emails.venue-proposal-declined-dark', ['data' => $payload])
            ->subject('[Ticketoc] Proposal declined for ' . $venueName);
    }
